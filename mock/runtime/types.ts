...
export type StoredFile = { idea_id?: string; id: string; client_id: string | null; original_name: string; file_name: string; content_type: string; size_bytes: number; status: FileStatus; category: string; uploaded_by_id: string; created_at: string };
