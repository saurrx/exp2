...
export const InvitationLongWorkspace: Story = { ...SuccessfulInvitation, tags:["viewport:640x360@2"], parameters:{pulse:{scenario:"v0/auth/long-workspace",path:"/i/:inviteCode",route:inviteRoute}}, play:async({canvasElement})=>{const c=await verifyInvitation(canvasElement);await expect(await c.findByText("Northwind Instruments and Advanced Measurement Research Laboratories")).toBeVisible();} };
