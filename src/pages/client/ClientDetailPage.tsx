...
const ClientDetailPage: React.FC = () => {
  ...
  return <>
    ...
    <div data-client-workspace className="mx-auto w-full max-w-screen-2xl px-6 pb-10 pt-3 text-pl-ink md:px-8 md:pt-6">
