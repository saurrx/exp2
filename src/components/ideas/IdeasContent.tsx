...
const IdeasContent: React.FC = () => {
  ...
  return <div data-ideas-list className="min-w-0 flex-1 bg-pl-bg-subtle p-6 text-pl-ink">
    ...
    <Button size="sm" variant="outline" className="mt-4 md:hidden" aria-expanded={filtersOpen} aria-controls="ideas-filters" onClick={() => setFiltersOpen((open) => !open)}>Filters and sort <ChevronDown aria-hidden="true" /></Button>
