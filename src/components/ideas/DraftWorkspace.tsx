...
const DraftWorkspace = ({ ideaId }: { ideaId?: string }) => {
  ...
  useEffect(() => {
    if (draftData && !loadedRef.current) {
      ...
      if (draftData?.data?.evaluation_context?.is_current === false) setDirtySinceScore(true);
